...
export async function createBanner(data: BannerData) {
  ...
  return prisma.banner.create({
    data: {
      ...
      buttonText: (data.buttonText ?? null) as unknown as Prisma.InputJsonValue,
...
export async function updateBanner(id: string, data: UpdateBannerInput) {
  ...
  return prisma.banner.update({
    ...
    data: {
      ...
      ...(data.showButton !== undefined && { showButton: data.showButton }),
      ...(data.buttonText !== undefined && {
        buttonText: data.buttonText as unknown as Prisma.InputJsonValue,
      }),
